<?php
    ...
    //page titlebar
    page_title_bar();
    $page_titlebar_icon = "flaticon-group41";
    $page_titlebar_header = "people";
    $page_titlebar_desc = " you have <strong> 105 </strong> users' links";
            ...
            <div class="wrap">
                ...
                <div class="row">
                    ...
                    <div class="full-indiv-link">
                        <div class="full-indiv-link-pone">
                            <div class="full-indiv-link-avatar">
                                <img alt="avatat" class="img-rounded" src="../images/asa-profile-pic.jpg" />
                            </div>
                            <div class="full-indiv-link-verf">
                                <i class="icon-checkmark"></i>
                            </div>
                    ...
                    <div class="people-page-more"> view more people</div>
